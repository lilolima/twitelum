...
class Tweet extends Component {
    ...
    handleLike = (idDoTweet) => {
        ...
        this.setState({
            likeado: !likeado,totalLikes: likeado ? totalLikes - 1 : totalLikes + 1
          })
          // Mandar tudo pra API
              ...
              <article className="tweet">
                  ...
                  <footer className="tweet__footer">
                      <button className="btnTweet btn btn--clean" onClick={(event) => this.handleLike(this.props.tweetInfo._id)}>
                          <svg
                              className={`icon icon--small iconHeart${this.state.likeado ? 'iconHeart--active' : ''}` } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47.5 47.5">
                              <defs>
                                  <clipPath id="a">
